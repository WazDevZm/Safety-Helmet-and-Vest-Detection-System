"""
Safety Helmet and Vest Detection System - Simplified Streamlit App
Simplified version without matplotlib to avoid NumPy compatibility issues
"""
    ...
    with col2:
        ...
        if 'results' in st.session_state:
            ...
            if show_statistics:
                ...
                # Create simple compliance chart using Streamlit
                compliance_data = {
